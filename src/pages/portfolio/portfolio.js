        ...
        if (res.data) {
          if (res.data.data.metadata) {
            const responseUri = await axios.get(
              res.data.data.metadata.data.uri
            );
          ...
          if (selectedToken.tokenName === "SOL") {
            ...
            if (resultSendAmount >= 0) {
              setRemainSolanaAmount(
                LBN(resultSendAmount, solanaDecimalLength).replace(/0+$/, "")
              );
        ...
        <div className="p-10 break-words">
          ...
          {selectedToken && (
            <p className="mt-5 text-2xl md:text-lg md:mt-2">
              {LBN(sendAmount, selectedToken.decimal).replace(/0+$/, "")}{" "}
            ...
            {tokenList &&
              ...
              tokenList.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-end flex-shrink-0 mt-5 mb-5">
